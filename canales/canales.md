...
| **Instagram** (Oficina/Estudio) | cercano (ámbar/celeste) | post 1:1 + Reel 9:16 | `social_autopost.py` (FB/IG) + video HeyGen (futuro) | rotador |
...
| **Video / Reels** (nuevo) | Jhonson (ventas) / Sofía (educa, celeste) | 9:16 avatar | **HeyGen** (a cablear) → publica vía social_post | por diseñar |
...
- **Acento por marca no se mezcla** entre canales: Oficina = ámbar #ecd175, Estudio/Sofía = celeste #5b9cf6, verde #3ecf8e = señal viva.
